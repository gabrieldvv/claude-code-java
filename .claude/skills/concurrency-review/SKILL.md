...
The severity levels below reuse the high/medium/low scale from the **Concurrency Review Checklist** above (🔴 High / 🟡 Medium / 🟢 lower priority) — the checklist tells you *what* to look for, this section tells you *how* to report each finding.

Report each finding with these fields:

| Field | Content |
|---|---|
| **Severity** | high / medium / low — based on likelihood and impact of races, deadlocks, visibility bugs, or data corruption |
